...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> Manual Gateway </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Manage Payment Gateway Manual</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="form-group float-right">
                                ...
                                <a class="btn btn-success" href="{{route('gateway.create')}}">
                                    <i class="fa fw fa-plus"></i> Add New
                                </a>
                            </div>
                            <h4 class="float-left">Gateway Manual</h4>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ url('admin/delete-selected-gateway') }}" method="post"
                                      id="delete-form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Edit Course" class="btn btn-primary btn-circle"
                                                       href="{{route('gateway.edit', $r->id)}}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-circle"
                                                       onclick="event.preventDefault();del({{$r->id}});"
                                                       title="Delete Payment Method" href="javascript:void(0)">
...
@section('scripts')
    ...
    <script>
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getgateways_details') }}", {
                _token: CSRF_TOKEN,
                id: id
