                                    ...
                                    <table id="datatable" class="table table-bordered table-striped">
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" onclick="event.preventDefault(); viewInfo({{ $product->id }});"
                                                    ...
                                                    <a class="btn btn-danger btn-circle" onclick="event.preventDefault(); del({{ $product->id }});"
