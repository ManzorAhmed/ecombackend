            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Manage CSV</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
{{--                                @can('user-delete')--}}
                                    ...
                                    <a class="btn btn-success" href="{{route('csv.create')}}">
...
{{--                                                </td>--}}
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Edit CSV" class="btn btn-primary btn-circle"
                                                       href="{{route('csv.edit', $r->id)}}">
