            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('agenda.index')}}">Agenda Topic List</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Create Agenda</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{ Form::open([ 'route' => 'agenda.store','class'=>'form-horizontal','enctype'=>'multipart/form-data']) }}
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hall"
                                               ...
                                               id="hall" value="{{ old('hall') }}"
                                               placeholder="Enter Your Hall Name Here">
                                        @error('hall')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="hall_color">Select Hall/Room Color</label>
                                        <input type="color" name="hall_color" class="form-control" id="hall_color"
                                               value="{{ old('hall_color', isset($agenda) ? $agenda->hall_color : '#FFFFFF') }}">
                                        @error('hall_color')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="session_color" class="form-control" id="session_color"
                                               value="{{ old('row_color', isset($agenda) ? $agenda->color : '#FFFFFF') }}">
                                        @error('session_color')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="event_date" class="form-control {{ $errors->has('time') ? 'is-invalid' : '' }}"
                                               id="event_date" value="{{ old('event_date') }}" placeholder="Select Conference Date ">
                                        @error('event_date')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="track"
                                               ...
                                               id="track" value="{{ get_static_option('track') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="chair_speaker"
                                                  ...
                                                  id="chair_speaker"
                                                  placeholder="Enter the Chair Speaker">{{ old('chair_speaker') }}</textarea>
                                        @error('chair_speaker')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="chair_speaker_color" class="form-control"
                                               id="chair_speaker_color"
                                               value="{{ old('chair_speaker_color', '#FFFFFF') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="topic"
                                                  ...
                                                  id="topic" placeholder="Enter the Topic">{{ old('topic') }}</textarea>
                                        @error('topic')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="topic_color" class="form-control"
                                               id="topic_color"
                                               value="{{ old('topic_color', '#FFFFFF') }}">
                                        @error('topic_color')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ceremony">Add Record for Opening Ceremony,Closing Coffee Break Lunch
                                            Symposium</label>
                                        <textarea name="ceremony"
                                                  class="form-control {{ $errors->has('ceremony') ? 'is-invalid' : '' }}"
                                                  id="ceremony"
                                                  placeholder="Enter the Record for Opening Ceremony,closing Coffee Break Lunch Symposium etc ">{{ old('Ceremony') }}</textarea>
                                        @error('ceremony')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="ceremony_color" class="form-control"
                                               id="ceremony_color"
                                               value="{{ old('ceremony_color', '#FFFFFF') }}">
