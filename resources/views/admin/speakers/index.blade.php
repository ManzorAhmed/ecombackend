...
{{--                            @if(Auth::user()->role == 'admin')--}}
                                <div class="form-group float-right">
                                    @can('user-delete')
                                        ...
                                        <a class="btn btn-success" href="{{route('speaker.create')}}">
                                            <i class="fa fw fa-plus"></i> Add New
                                        </a>
                                    @endcan
                                </div>
{{--                            @endif--}}
                            <h4 class="float-left">Faculty List</h4>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Speaker Detail</h4>
...
@section('scripts')
    <script type="text/javascript">
        function del(id) {
            swal.fire({
                ...
                title: "Are you sure!",
                text: "This Speaker will be deleted permanently",
                type: "warning",
                ...
                .then((result) => {
                    if (result.value) {
                        var APP_URL = {!! json_encode(url('/')) !!}
                            window.location.href = APP_URL + "/admin/speaker/delete/" + id;
                    }
                });
        }
        ...
        function del_selected() {
            swal.fire({
                title: "Are you sure?",
                text: "These speaker/speakers will be deleted permanently",
                type: "warning",
                showCancelButton: true,
                ...
                .then((result) => {
                    if (result.value) {
                        $("#delete-form").submit();
                        setTimeout(function () {
                            swal("Speaker deleted successfully. Thanks");
                        }, 2000);
                    }
                });
        }
    ...
    <script>
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getSpeakerDetail') }}", {
                _token: CSRF_TOKEN,
                id: id
